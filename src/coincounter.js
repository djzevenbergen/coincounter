...
export const counter = (denomination) => {
  return (money) => {
    return Math.floor((money / denomination))
  }
}

export const quarter = counter(.25);
export const dime = counter(.1);
export const nickel = counter(.05);

export const coinCounter2 = (money) => {
